package com.grabandgo.server.scanner.security;
...
public class GagUserInfoTokenServices implements ResourceServerTokenServices {
	...
	public GagUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
